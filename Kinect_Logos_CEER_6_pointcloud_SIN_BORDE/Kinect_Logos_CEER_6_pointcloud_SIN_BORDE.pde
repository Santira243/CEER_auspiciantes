...
void drawHandState(KJoint joint, char a) {
  ...
  Vec2 hand = new Vec2(x_track ,y_track);
   for (int i =particulas.size()-1; i >= 0; i--) // The Nature of Code
// <http://www.shiffman.net/teaching/nature>
// Spring 2011
// Box2DProcessing example
...
int yfactor = 3;//2
int zfactor = 30; //20
int offsetx =50; //width+500;
int offsety =50; //int(height*2.3);

float polygonFactor = 0.5;
